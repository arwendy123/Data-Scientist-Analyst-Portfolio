# Arwendy Melyndra - Data Scientist | Data Analyst Portfolio
...
My resume in [pdf](https://github.com/arwendy123/data-scientist-analyst-portfolio/blob/main/Arwendy%20Melyndra%20-%20Data%20Analytics%20-%20Resume.pdf)
...
**Code:**
[Here](https://github.com/arwendy123/customer-segmentation-analysis/blob/main/customer_segmentation.ipynb)

**Description:**
This project focuses on customer segmentation in the retail industry using unsupervised clustering techniques. The goal is to identify distinct groups of customers based on their behaviour, demographics, and purchasing patterns. By segmenting customers into meaningful clusters, retailers can gain valuable insights into their customer base and tailor their marketing strategies accordingly.
...
- Profiling and segmenting customer groups
- Data visualization
...
**Results:**
The analysis reveals distinct customer segments with diverse characteristics and preferences. The identified clusters provide valuable insights into the customer base, allowing retailers to understand their customers better and tailor their marketing efforts accordingly. By targeting specific customer segments with personalized campaigns, retailers can improve customer engagement, increase sales, and enhance overall customer satisfaction.
